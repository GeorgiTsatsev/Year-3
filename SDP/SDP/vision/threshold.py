...
#	frame3 = frame
#	
#	[x,y]=cv.GetSize(iplframe3)
#
#	box_top = (0, 0, x, y / 2)
#	temp = Image(iplframe)
#	top_partt = Image(temp.crop(box_top))
#
#
#	top_part = top_partt.getBitmap()
#	
#	iplresult3 = cv.CreateImage(cv.GetSize(iplframe3), frame3.depth, 1)
#       cv.InRangeS(iplresult3, threshmin, threshmax, iplresult3)
	#iplframe.paste(top_part, box_top)	
	...
	#cv.InRangeS(iplframe,[255, 255, 255], [255, 255, 255], iplresult)
        ...
        if crossover:
          ...
          # cv.InRangeS(iplframe,[700, 255, 255], [255, 255, 255], iplresult2)
