...
This is the release 2.6 of the Java Neural Network Framework Neuroph
...
- improved image recognition wizard in Neuroph Studio, and support for android 
- data normalization support
- io adapters for files, database, url, streams
- weight randomization techniques
